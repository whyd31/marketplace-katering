...
@section('container')
    ...
    <a href="/dashboard/users/create" class="btn btn-primary mb-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Create">Create a New user</a>
        <table class="table table-striped table-sm">
          ...
          @foreach ($users as $user)
              <tr>
                ...
                <td>{{ $user->username }}</td>
                <td>{{ $user->email }}</td>
                <td> @if ($user->1) Admin @else User @endif </td>  
                <td>
